...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "reader.autotvin.dat"
	set constFileTvOut       "reader.autotvout.dat"
	set constFileHdlTvIn     "reader.autohdltvin.dat"
	set constFileHdlTvOut    "reader.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
