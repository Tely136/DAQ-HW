...
if {[file isfile stream_reader.autotvin.dat]} {
	file delete -force stream_reader.autotvin.dat
}

if {[file isfile stream_reader.autotvout.dat]} {
	file delete -force stream_reader.autotvout.dat
}
