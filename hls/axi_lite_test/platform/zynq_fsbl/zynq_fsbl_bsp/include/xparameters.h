...
#define XPAR_EXAMPLE_0_COMPATIBLE "xlnx,example-1.0"
#define XPAR_EXAMPLE_0_BASEADDR 0x40020000
#define XPAR_EXAMPLE_0_HIGHADDR 0x4002ffff

/* Canonical definitions for peripheral EXAMPLE_0 */
#define XPAR_XEXAMPLE_0_BASEADDR 0x40020000
#define XPAR_XEXAMPLE_0_HIGHADDR 0x4002ffff
#define XPAR_XEXAMPLE_0_COMPATIBLE "xlnx,example-1.0"
