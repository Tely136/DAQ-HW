...
`ifndef STREAM_GENERATOR_SUBSYSTEM_MONITOR_SV
`define STREAM_GENERATOR_SUBSYSTEM_MONITOR_SV
...
class stream_generator_subsystem_monitor extends uvm_component;

    stream_generator_reference_model refm;
    stream_generator_scoreboard scbd;

    `uvm_component_utils_begin(stream_generator_subsystem_monitor)
    `uvm_component_utils_end

    uvm_analysis_imp_svr_slave_out_r#(svr_pkg::svr_transfer#(32), stream_generator_subsystem_monitor) svr_slave_out_r_imp;
    uvm_analysis_imp_axi_wtr_gmem#(axi_pkg::axi_transfer, stream_generator_subsystem_monitor) gmem_wtr_imp;
    uvm_analysis_imp_axi_rtr_gmem#(axi_pkg::axi_transfer, stream_generator_subsystem_monitor) gmem_rtr_imp;
    uvm_analysis_imp_axi_wtr_control#(axi_pkg::axi_transfer, stream_generator_subsystem_monitor) control_wtr_imp;
    uvm_analysis_imp_axi_rtr_control#(axi_pkg::axi_transfer, stream_generator_subsystem_monitor) control_rtr_imp;
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        scbd = stream_generator_scoreboard::type_id::create("scbd", this);
    endfunction
