...
entity blinker is
generic (
    C_S_AXI_TEST_ADDR_WIDTH : INTEGER := 5;
...
architecture behav of blinker is 
    ...
    signal trunc_ln12_fu_74_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal icmp_ln12_fu_68_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln17_fu_85_p1 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component blinker_test_s_axi IS
    generic (
...
begin
    test_s_axi_U : component blinker_test_s_axi
    generic map (
    ...
    C_assign_proc : process(ap_start, ap_CS_fsm_state1, trunc_ln12_fu_74_p1, ap_CS_fsm_state2, icmp_ln12_fu_68_p2)
    begin
        if (((icmp_ln12_fu_68_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    D_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state2, trunc_ln17_fu_85_p1, icmp_ln17_fu_79_p2)
    begin
        if (((icmp_ln17_fu_79_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    icmp_ln12_fu_68_p2 <= "1" when (signed(A) > signed(ap_const_lv32_0)) else "0";
    icmp_ln17_fu_79_p2 <= "1" when (signed(B) > signed(ap_const_lv32_0)) else "0";
    trunc_ln12_fu_74_p1 <= A(1 - 1 downto 0);
    trunc_ln17_fu_85_p1 <= B(1 - 1 downto 0);
end behav;
