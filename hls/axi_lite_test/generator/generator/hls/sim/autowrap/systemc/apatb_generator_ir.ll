; ModuleID = 'C:/DAQ-HW/hls/axi_lite_test/generator/generator/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_generator_ir(%"class.hls::stream<int>"* noalias nocapture nonnull align 4 dereferenceable(4) %out) local_unnamed_addr #1 {
entry:
  %out_copy = alloca i32, align 512
  call void @llvm.sideeffect() #7 [ "stream_interface"(i32* %out_copy, i32 0) ]
  call fastcc void @copy_in(%"class.hls::stream<int>"* nonnull %out, i32* nonnull align 512 %out_copy)
  call void @apatb_generator_hw(i32* %out_copy)
  call void @copy_back(%"class.hls::stream<int>"* %out, i32* %out_copy)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_in(%"class.hls::stream<int>"* noalias "unpacked"="0", i32* noalias nocapture align 512 "unpacked"="1.0") unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<int>"* noalias "unpacked"="0", i32* noalias nocapture align 512 "unpacked"="1.0") unnamed_addr #5 {
entry:
...
declare void @apatb_generator_hw(i32* %out)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<int>"* noalias "unpacked"="0", i32* noalias nocapture align 512 "unpacked"="1.0") unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<int>.4"(%"class.hls::stream<int>"* %0, i32* align 512 %1)
  ret void
}

declare void @generator_hw_stub(%"class.hls::stream<int>"* noalias nocapture nonnull)

define void @generator_hw_stub_wrapper(i32* %out) #6 {
entry:
  %0 = call i8* @malloc(i64 4)
  %1 = bitcast i8* %0 to %"class.hls::stream<int>"*
  call void @copy_out(%"class.hls::stream<int>"* %1, i32* %out)
  call void @generator_hw_stub(%"class.hls::stream<int>"* %1)
  call void @copy_in(%"class.hls::stream<int>"* %1, i32* %out)
  call void @free(i8* %0)
  ret void
}
