...
// wrapc file define:
#define AUTOTB_TVOUT_out_r "../tv/cdatafile/c.generator.autotvout_out_r.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_out_r "../tv/rtldatafile/rtl.generator.autotvout_out_r.dat"
...
extern "C"
void generator_hw_stub_wrapper(void*);

extern "C"
void apatb_generator_hw(void* __xlx_apatb_param_out)
{
  ...
  try {
    ...
    generator_hw_stub_wrapper(__xlx_apatb_param_out);
    port0.buffer();
