...
$(ObjDir)/generator_test.cpp_pre.o : generator_test.cpp_pre.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling generator_test.cpp_pre.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $<  -build-hls-cosim-wrapper=generator -o $@; 

$(ObjDir)/generator.cpp_pre.o : generator.cpp_pre.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling generator.cpp_pre.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $<  -build-hls-cosim-wrapper=generator -o $@; 
