...
`define AUTOTB_DUT      generator
`define AUTOTB_DUT_INST AESL_inst_generator
`define AUTOTB_TOP      apatb_generator_top
`define AUTOTB_LAT_RESULT_FILE "generator.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "generator.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_generator_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_out_r 1
`define AUTOTB_TVOUT_out_r  "../tv/cdatafile/c.generator.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "../tv/rtldatafile/rtl.generator.autotvout_out_r.dat"
module `AUTOTB_TOP;
