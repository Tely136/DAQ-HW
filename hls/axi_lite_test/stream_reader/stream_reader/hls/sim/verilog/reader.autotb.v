...
`define AUTOTB_DUT      reader
`define AUTOTB_DUT_INST AESL_inst_reader
`define AUTOTB_TOP      apatb_reader_top
`define AUTOTB_LAT_RESULT_FILE "reader.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "reader.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_reader_top
...
`define AUTOTB_TVIN_in_r  "../tv/cdatafile/c.reader.autotvin_in_r.dat"
`define AUTOTB_TVIN_out_r  "../tv/cdatafile/c.reader.autotvin_out_r.dat"
`define AUTOTB_TVIN_in_r_out_wrapc  "../tv/rtldatafile/rtl.reader.autotvin_in_r.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "../tv/rtldatafile/rtl.reader.autotvin_out_r.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.reader.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.reader.autotvout_gmem.dat"
module `AUTOTB_TOP;
