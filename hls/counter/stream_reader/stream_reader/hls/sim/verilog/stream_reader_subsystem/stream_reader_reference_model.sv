...
`ifndef STREAM_READER_REFERENCE_MODEL_SV
`define STREAM_READER_REFERENCE_MODEL_SV
typedef class stream_reader_reference_model;
...
class stream_reader_reference_model extends uvm_component;
`define TV_IN_gmem "../tv/cdatafile/c.stream_reader.autotvin_gmem.dat"
`define TV_OUT_gmem "../tv/rtldatafile/rtl.stream_reader.autotvout_gmem.dat"
`define TV_IN_OFFSET_data_out "../tv/cdatafile/c.stream_reader.autotvin_data_out.dat"
`define TV_IN_data_out "../tv/cdatafile/c.stream_reader.autotvin_data_out.dat"
`define TV_OUT_data_out ""
`define TV_IN_n_outer "../tv/cdatafile/c.stream_reader.autotvin_n_outer.dat"
`define TV_OUT_n_outer ""
`define TV_IN_n_inner "../tv/cdatafile/c.stream_reader.autotvin_n_inner.dat"
`define TV_OUT_n_inner ""
    ...
    mem_model_pages#(32,8) mem_blk_pages_control_n_outer;
    mem_model_pages#(32,8) mem_blk_pages_control_n_inner;
    int svr_data_in_delay;
    covergroup svr_data_in_cov;
        delay: coverpoint svr_data_in_delay
        {
            bins norm[2] = { [0 : 1] };
        }
    endgroup
    
    `uvm_component_utils_begin(stream_reader_reference_model)
...
misc_if.dut2tb_ap_done = 0;
        ...
        fpath.push_back(`TV_IN_n_outer);
        mem_blk_pages_control_n_outer = mem_model_pages#(32,8)::type_id::create("mem_blk_pages_control_n_outer");
        mem_blk_pages_control_n_outer.tvinload_pagechk_atinit(fpath, 1*((32+7)/8), 0, 28);
        fpath.delete;


        fpath.push_back(`TV_IN_n_inner);
        mem_blk_pages_control_n_inner = mem_model_pages#(32,8)::type_id::create("mem_blk_pages_control_n_inner");
        mem_blk_pages_control_n_inner.tvinload_pagechk_atinit(fpath, 1*((32+7)/8), 0, 36);
        fpath.delete;
        ...
        mem_blk_pages_gmem.maxi_bundlevar_fpath["data_out"]=`TV_IN_OFFSET_data_out;
    ...
    virtual function void write_svr_master_data_in(svr_transfer#(32) tr);
    //  trans_size++;
        svr_data_in_delay = tr.delay;
        svr_data_in_cov.sample();
