...
class mem_model#(int WIDTH = 8) extends uvm_object;
    ...
    function void init(int unsigned depth, int unsigned offset=0);
        mem = new[depth];
        IsWr = new[depth];
...
class mem_model_pages#(int DATA_WIDTH=32, int ELE_WIDTH = 8) extends uvm_object;
    ...
    virtual function void init_pages(int trans_num, int unsigned depth, int unsigned offset=0);
    ...
    virtual function void tvinload_pagechk_atinit(string fpath[$], int unsigned depth, bit ispagechk=0, int unsigned offset=0);
