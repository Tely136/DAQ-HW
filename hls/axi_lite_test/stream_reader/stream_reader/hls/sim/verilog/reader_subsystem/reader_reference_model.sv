...
`ifndef READER_REFERENCE_MODEL_SV
`define READER_REFERENCE_MODEL_SV
typedef class reader_reference_model;
...
class reader_reference_model extends uvm_component;
`define TV_IN_gmem "../tv/cdatafile/c.reader.autotvin_gmem.dat"
`define TV_OUT_gmem "../tv/rtldatafile/rtl.reader.autotvout_gmem.dat"
`define TV_IN_OFFSET_out_r "../tv/cdatafile/c.reader.autotvin_out_r.dat"
`define TV_IN_out_r "../tv/cdatafile/c.reader.autotvin_out_r.dat"
`define TV_OUT_out_r ""
    ...
    int svr_in_r_delay;
    covergroup svr_in_r_cov;
        delay: coverpoint svr_in_r_delay
        {
            bins norm[59] = { [0 : 58] };
        }
    endgroup
    
    `uvm_component_utils_begin(reader_reference_model)
...
misc_if.dut2tb_ap_done = 0;
        ...
        mem_blk_pages_gmem.whole_page_size=264;
        mem_blk_pages_gmem.maxi_bundlevar_fpath["out_r"]=`TV_IN_OFFSET_out_r;
        mem_blk_pages_gmem.set_binary(1);
        mem_blk_pages_gmem.tvinload_pagechk_atinit(fpath, 50*((32+7)/8), 0, 0);
