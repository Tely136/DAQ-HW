...
`define AUTOTB_DUT      stream_generator
`define AUTOTB_DUT_INST AESL_inst_stream_generator
`define AUTOTB_TOP      apatb_stream_generator_top
`define AUTOTB_LAT_RESULT_FILE "stream_generator.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "stream_generator.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_stream_generator_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_gmem 1
`define AESL_DEPTH_out_r 1
`define AESL_DEPTH_n_total 1
...
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.stream_generator.autotvin_gmem.dat"
`define AUTOTB_TVIN_n_total_out_wrapc  "../tv/rtldatafile/rtl.stream_generator.autotvin_n_total.dat"
`define AUTOTB_TVIN_data_out_wrapc  "../tv/rtldatafile/rtl.stream_generator.autotvin_data.dat"
`define AUTOTB_TVOUT_out_r  "../tv/cdatafile/c.stream_generator.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "../tv/rtldatafile/rtl.stream_generator.autotvout_out_r.dat"
module `AUTOTB_TOP;
...
parameter LENGTH_n_total = 1;
parameter LENGTH_out_r = 50;
