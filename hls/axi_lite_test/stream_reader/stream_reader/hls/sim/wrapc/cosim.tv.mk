...
$(ObjDir)/stream_reader_test.cpp_pre.o : stream_reader_test.cpp_pre.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling stream_reader_test.cpp_pre.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $<  -build-hls-cosim-wrapper=reader -o $@; 

$(ObjDir)/stream_reader.cpp_pre.o : stream_reader.cpp_pre.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling stream_reader.cpp_pre.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $<  -build-hls-cosim-wrapper=reader -o $@; 
