...
if {[file isfile stream_generator.autotvin.dat]} {
	file delete -force stream_generator.autotvin.dat
}

if {[file isfile stream_generator.autotvout.dat]} {
	file delete -force stream_generator.autotvout.dat
}
