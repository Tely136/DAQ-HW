...
//
//==============================================================
`ifndef READER_SCOREBOARD__SV                                                       
    `define READER_SCOREBOARD__SV                                                   
                                                                                               
                                                                                               
    class reader_scoreboard extends uvm_component;                                        
                                                                                               
        reader_reference_model refm;                                                      
                                                                                               
                                                                                               
        `uvm_component_utils_begin(reader_scoreboard)                                     
        ...
        virtual function void write_svr_master_in_r(svr_transfer#(32) tr);
            `uvm_info(this.get_full_name(), "port in_r collected one pkt", UVM_DEBUG);          
        endfunction
