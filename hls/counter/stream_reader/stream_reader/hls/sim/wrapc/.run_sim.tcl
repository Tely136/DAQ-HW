...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "stream_reader.autotvin.dat"
	set constFileTvOut       "stream_reader.autotvout.dat"
	set constFileHdlTvIn     "stream_reader.autohdltvin.dat"
	set constFileHdlTvOut    "stream_reader.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
