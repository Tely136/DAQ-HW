...
//
//==============================================================
`ifndef GENERATOR_SCOREBOARD__SV                                                       
    `define GENERATOR_SCOREBOARD__SV                                                   
                                                                                               
    `define AUTOTB_TVOUT_out_r_out_r_TDATA_wrapc  "../tv/rtldatafile/rtl.generator.autotvout_out_r.dat"
    `define STREAM_SIZE_OUT_out_r_out_r_TDATA  "../tv/stream_size/stream_size_out_out_r.dat"
                                                                                               
    class generator_scoreboard extends uvm_component;                                        
        ...
        `uvm_component_utils_begin(generator_scoreboard)                                     
