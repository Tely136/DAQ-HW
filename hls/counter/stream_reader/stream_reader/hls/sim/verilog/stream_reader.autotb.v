...
`define AUTOTB_DUT      stream_reader
`define AUTOTB_DUT_INST AESL_inst_stream_reader
`define AUTOTB_TOP      apatb_stream_reader_top
`define AUTOTB_LAT_RESULT_FILE "stream_reader.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "stream_reader.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_stream_reader_top
...
`define AESL_DEPTH_n_outer 1
`define AESL_DEPTH_n_inner 1
...
`define AUTOTB_TVIN_data_in_out_wrapc  "../tv/rtldatafile/rtl.stream_reader.autotvin_data_in.dat"
`define AUTOTB_TVIN_data_out_out_wrapc  "../tv/rtldatafile/rtl.stream_reader.autotvin_data_out.dat"
`define AUTOTB_TVIN_n_outer_out_wrapc  "../tv/rtldatafile/rtl.stream_reader.autotvin_n_outer.dat"
`define AUTOTB_TVIN_n_inner_out_wrapc  "../tv/rtldatafile/rtl.stream_reader.autotvin_n_inner.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.stream_reader.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.stream_reader.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_data_in = 50;
parameter LENGTH_data_out = 1;
parameter LENGTH_gmem = 128;
parameter LENGTH_n_inner = 1;
parameter LENGTH_n_outer = 1;
