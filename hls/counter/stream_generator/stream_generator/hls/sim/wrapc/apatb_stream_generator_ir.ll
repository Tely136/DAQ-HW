; ModuleID = 'C:/DAQ-HW/hls/counter/stream_generator/stream_generator/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_stream_generator_ir(%"class.hls::stream<int>"* noalias nocapture nonnull align 4 dereferenceable(4) %out, i32 %n_total, i32* noalias nocapture nonnull readonly "maxi" %data) local_unnamed_addr #1 {
entry:
  %out_copy = alloca i32, align 512
  call void @llvm.sideeffect() #9 [ "stream_interface"(i32* %out_copy, i32 0) ]
  %0 = bitcast i32* %data to [128 x i32]*
  %data_copy = alloca [128 x i32], align 512
  call fastcc void @copy_in(%"class.hls::stream<int>"* nonnull %out, i32* nonnull align 512 %out_copy, [128 x i32]* nonnull %0, [128 x i32]* nonnull align 512 %data_copy)
  call void @apatb_stream_generator_hw(i32* %out_copy, i32 %n_total, [128 x i32]* %data_copy)
  call void @copy_back(%"class.hls::stream<int>"* %out, i32* %out_copy, [128 x i32]* %0, [128 x i32]* %data_copy)
  ret void
}
...
declare void @apatb_stream_generator_hw(i32* %out, i32 %n_total, [128 x i32]* %data)
...
declare void @stream_generator_hw_stub(%"class.hls::stream<int>"* noalias nocapture nonnull, i32, i32* noalias nocapture nonnull readonly)

define void @stream_generator_hw_stub_wrapper(i32* %out, i32 %n_total, [128 x i32]* %data) #8 {
entry:
  %0 = call i8* @malloc(i64 4)
  %1 = bitcast i8* %0 to %"class.hls::stream<int>"*
  call void @copy_out(%"class.hls::stream<int>"* %1, i32* %out, [128 x i32]* null, [128 x i32]* %data)
  %2 = bitcast [128 x i32]* %data to i32*
  call void @stream_generator_hw_stub(%"class.hls::stream<int>"* %1, i32 %n_total, i32* %2)
  call void @copy_in(%"class.hls::stream<int>"* %1, i32* %out, [128 x i32]* null, [128 x i32]* %data)
  call void @free(i8* %0)
  ret void
}
