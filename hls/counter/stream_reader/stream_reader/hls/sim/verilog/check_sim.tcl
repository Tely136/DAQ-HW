...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.stream_reader.autotvin_data_in.dat"
         "c.stream_reader.autotvin_data_out.dat"
         "c.stream_reader.autotvin_n_outer.dat"
         "c.stream_reader.autotvin_n_inner.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.stream_reader.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
