...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "generator.autotvin.dat"
	set constFileTvOut       "generator.autotvout.dat"
	set constFileHdlTvIn     "generator.autohdltvin.dat"
	set constFileHdlTvOut    "generator.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
