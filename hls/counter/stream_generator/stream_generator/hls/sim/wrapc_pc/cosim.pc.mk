...
AUTOPILOT_ROOT := C:/AMDDesignTools/2026.1/Vitis
...
ifndef AP_GCC_PATH
  AP_GCC_PATH := C:/AMDDesignTools/2026.1/Vitis/tps/mingw/10.0.0/win64.o/nt/bin
endif
AUTOPILOT_TOOL = ${AUTOPILOT_ROOT}/${AUTOPILOT_MACH}/tools
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
AP_CLANG_PATH := ${AUTOPILOT_ROOT}/win64/tools/clang-16/bin
TOOLCHAIN += --sysroot=C:/AMDDesignTools/2026.1/Vitis/tps/mingw/10.0.0/win64.o/nt
LFLAG += --sysroot=C:/AMDDesignTools/2026.1/Vitis/tps/mingw/10.0.0/win64.o/nt
...
$(ObjDir)/stream_generator_test.cpp_pre.o : stream_generator_test.cpp_pre.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling stream_generator_test.cpp_pre.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $<  -build-hls-cosim-wrapper=stream_generator -o $@; 

$(ObjDir)/stream_generator.cpp_pre.o : stream_generator.cpp_pre.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling stream_generator.cpp_pre.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $<  -build-hls-cosim-wrapper=stream_generator -o $@; 
