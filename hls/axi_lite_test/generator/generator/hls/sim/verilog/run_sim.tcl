...
if {[file isfile generator.autotvin.dat]} {
	file delete -force generator.autotvin.dat
}

if {[file isfile generator.autotvout.dat]} {
	file delete -force generator.autotvout.dat
}
