...
# 
# ==============================================================
set ::env(PATH) "C:/AMDDesignTools/2026.1/Vitis/win64/tools/fpo_v7_1;$::env(PATH)"
set ::env(PATH) "C:/AMDDesignTools/2026.1/Vitis/win64/tools/fft_v9_1;$::env(PATH)"
set ::env(PATH) "C:/AMDDesignTools/2026.1/Vitis/win64/tools/fir_v7_0;$::env(PATH)"
set ::env(PATH) "C:/AMDDesignTools/2026.1/Vitis/win64/tools/dds_v6_0;$::env(PATH)"
set ::env(PATH) "C:/AMDDesignTools/2026.1/Vitis/tps/mingw/10.0.0/win64.o/nt/bin;$::env(PATH)"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "stream_generator.autotvin.dat"
	set constFileTvOut       "stream_generator.autotvout.dat"
	set constFileHdlTvIn     "stream_generator.autohdltvin.dat"
	set constFileHdlTvOut    "stream_generator.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
