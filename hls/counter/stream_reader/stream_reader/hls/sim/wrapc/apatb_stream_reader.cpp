...
// wrapc file define:
#define AUTOTB_TVIN_data_in "../tv/cdatafile/c.stream_reader.autotvin_data_in.dat"
...
#define AUTOTB_TVIN_data_out "../tv/cdatafile/c.stream_reader.autotvin_data_out.dat"
#define AUTOTB_TVOUT_data_out "../tv/cdatafile/c.stream_reader.autotvout_data_out.dat"
#define AUTOTB_TVIN_n_outer "../tv/cdatafile/c.stream_reader.autotvin_n_outer.dat"
#define AUTOTB_TVOUT_n_outer "../tv/cdatafile/c.stream_reader.autotvout_n_outer.dat"
#define AUTOTB_TVIN_n_inner "../tv/cdatafile/c.stream_reader.autotvin_n_inner.dat"
#define AUTOTB_TVOUT_n_inner "../tv/cdatafile/c.stream_reader.autotvout_n_inner.dat"
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.stream_reader.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.stream_reader.autotvout_gmem.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.stream_reader.autotvout_gmem.dat"
...
extern "C"
void stream_reader_hw_stub_wrapper(void*, void*, hls::sim::Byte<4>, hls::sim::Byte<4>);

extern "C"
void apatb_stream_reader_hw(void* __xlx_apatb_param_data_in, void* __xlx_apatb_param_data_out, hls::sim::Byte<4> __xlx_apatb_param_n_outer, hls::sim::Byte<4> __xlx_apatb_param_n_inner)
{
  ...
  port0.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_data_in;
  port0.hasWrite = false;

  static hls::sim::Byte<4> __xlx_offset_byte_param_data_out;
  ...
  port1.param = &__xlx_offset_byte_param_data_out;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_n_outer),
#endif
  };
  port2.param = &__xlx_apatb_param_n_outer;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_n_inner),
#endif
  };
  port3.param = &__xlx_apatb_param_n_inner;
  ...
  port4.param = { __xlx_apatb_param_data_out };
  port4.mname = { "data_out" };
  port4.nbytes = { 512 };
  ...
  try {
    ...
    stream_reader_hw_stub_wrapper(__xlx_apatb_param_data_in, __xlx_apatb_param_data_out, __xlx_apatb_param_n_outer, __xlx_apatb_param_n_inner);
