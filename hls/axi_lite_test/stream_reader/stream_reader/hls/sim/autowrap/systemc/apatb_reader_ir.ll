; ModuleID = 'C:/DAQ-HW/hls/axi_lite_test/stream_reader/stream_reader/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_reader_ir(%"class.hls::stream<int>"* noalias nocapture nonnull align 4 dereferenceable(4) %in, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="50" "maxi" %out) local_unnamed_addr #1 {
entry:
  %in_copy = alloca i32, align 512
  call void @llvm.sideeffect() #9 [ "stream_interface"(i32* %in_copy, i32 0) ]
  %0 = bitcast i32* %out to [50 x i32]*
  %out_copy = alloca [50 x i32], align 512
  call fastcc void @copy_in(%"class.hls::stream<int>"* nonnull %in, i32* nonnull align 512 %in_copy, [50 x i32]* nonnull %0, [50 x i32]* nonnull align 512 %out_copy)
  call void @apatb_reader_hw(i32* %in_copy, [50 x i32]* %out_copy)
  call void @copy_back(%"class.hls::stream<int>"* %in, i32* %in_copy, [50 x i32]* %0, [50 x i32]* %out_copy)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_in(%"class.hls::stream<int>"* noalias "unpacked"="0", i32* noalias nocapture align 512 "unpacked"="1.0", [50 x i32]* noalias readonly "unpacked"="2", [50 x i32]* noalias align 512 "unpacked"="3") unnamed_addr #2 {
entry:
...
define internal fastcc void @onebyonecpy_hls.p0a50i32([50 x i32]* noalias align 512 %dst, [50 x i32]* noalias readonly %src) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a50i32([50 x i32]* %dst, [50 x i32]* readonly %src, i64 %num) local_unnamed_addr #6 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<int>"* noalias "unpacked"="0", i32* noalias nocapture align 512 "unpacked"="1.0", [50 x i32]* noalias "unpacked"="2", [50 x i32]* noalias readonly align 512 "unpacked"="3") unnamed_addr #7 {
entry:
...
declare void @apatb_reader_hw(i32* %in, [50 x i32]* %out_r)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<int>"* noalias "unpacked"="0", i32* noalias nocapture align 512 "unpacked"="1.0", [50 x i32]* noalias "unpacked"="2", [50 x i32]* noalias readonly align 512 "unpacked"="3") unnamed_addr #7 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<int>.4"(%"class.hls::stream<int>"* %0, i32* align 512 %1)
  call fastcc void @onebyonecpy_hls.p0a50i32([50 x i32]* %2, [50 x i32]* align 512 %3)
  ret void
...
declare void @reader_hw_stub(%"class.hls::stream<int>"* noalias nocapture nonnull, i32* noalias nocapture nonnull)

define void @reader_hw_stub_wrapper(i32* %in, [50 x i32]* %out_r) #8 {
entry:
  %0 = call i8* @malloc(i64 4)
  %1 = bitcast i8* %0 to %"class.hls::stream<int>"*
  call void @copy_out(%"class.hls::stream<int>"* %1, i32* %in, [50 x i32]* null, [50 x i32]* %out_r)
  %2 = bitcast [50 x i32]* %out_r to i32*
  call void @reader_hw_stub(%"class.hls::stream<int>"* %1, i32* %2)
  call void @copy_in(%"class.hls::stream<int>"* %1, i32* %in, [50 x i32]* null, [50 x i32]* %out_r)
  call void @free(i8* %0)
  ret void
}
