...
$(ObjDir)/counter_test.cpp_pre.o : counter_test.cpp_pre.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling counter_test.cpp_pre.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $<  -build-hls-cosim-wrapper=counter -o $@; 

$(ObjDir)/counter.cpp_pre.o : counter.cpp_pre.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling counter.cpp_pre.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $<  -build-hls-cosim-wrapper=counter -o $@; 
