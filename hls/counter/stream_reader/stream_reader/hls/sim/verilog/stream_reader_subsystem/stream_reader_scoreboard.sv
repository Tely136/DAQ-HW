...
//
//==============================================================
`ifndef STREAM_READER_SCOREBOARD__SV                                                       
    `define STREAM_READER_SCOREBOARD__SV                                                   
                                                                                               
                                                                                               
    class stream_reader_scoreboard extends uvm_component;                                        
                                                                                               
        stream_reader_reference_model refm;                                                      
                                                                                               
                                                                                               
        `uvm_component_utils_begin(stream_reader_scoreboard)                                     
        ...
        virtual task run_phase(uvm_phase phase);                                               
            ...
            fork                                                                               
                forever begin
                    ...
                    void'(refm.mem_blk_pages_control_n_outer.pages.pop_front());
                    void'(refm.mem_blk_pages_control_n_inner.pages.pop_front());
                end
        ...
        virtual function void write_svr_master_data_in(svr_transfer#(32) tr);
            `uvm_info(this.get_full_name(), "port data_in collected one pkt", UVM_DEBUG);          
        endfunction
