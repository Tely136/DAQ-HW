...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.stream_generator.autotvin_gmem.dat"
         "c.stream_generator.autotvin_n_total.dat"
         "c.stream_generator.autotvin_data.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.stream_generator.autotvout_out_r.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
