; ModuleID = 'C:/DAQ-HW/hls/counter/counter/counter/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_counter_ir(%"class.hls::stream<int>"* noalias nocapture nonnull align 4 dereferenceable(4) %data_in, i32* noalias nocapture nonnull "maxi" %data_out, i32 %n_outer, i32 %n_inner) local_unnamed_addr #1 {
entry:
  ...
  call fastcc void @copy_in(%"class.hls::stream<int>"* nonnull %data_in, i32* nonnull align 512 %data_in_copy, i32* nonnull %data_out, i32* nonnull align 512 %data_out_copy)
  call void @apatb_counter_hw(i32* %data_in_copy, i32* %data_out_copy, i32 %n_outer, i32 %n_inner)
  call void @copy_back(%"class.hls::stream<int>"* %data_in, i32* %data_in_copy, i32* %data_out, i32* %data_out_copy)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_in(%"class.hls::stream<int>"* noalias "unpacked"="0", i32* noalias nocapture align 512 "unpacked"="1.0", i32* noalias readonly "unpacked"="2", i32* noalias align 512 "unpacked"="3") unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<int>"* noalias "unpacked"="0", i32* noalias nocapture align 512 "unpacked"="1.0", i32* noalias "unpacked"="2", i32* noalias readonly align 512 "unpacked"="3") unnamed_addr #6 {
entry:
...
declare void @apatb_counter_hw(i32* %data_in, i32* %data_out, i32 %n_outer, i32 %n_inner)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<int>"* noalias "unpacked"="0", i32* noalias nocapture align 512 "unpacked"="1.0", i32* noalias "unpacked"="2", i32* noalias readonly align 512 "unpacked"="3") unnamed_addr #6 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<int>.4"(%"class.hls::stream<int>"* %0, i32* align 512 %1)
  call fastcc void @onebyonecpy_hls.p0i32(i32* %2, i32* align 512 %3)
  ret void
...
declare void @counter_hw_stub(%"class.hls::stream<int>"* noalias nocapture nonnull, i32* noalias nocapture nonnull, i32, i32)

define void @counter_hw_stub_wrapper(i32* %data_in, i32* %data_out, i32 %n_outer, i32 %n_inner) #7 {
entry:
  %0 = call i8* @malloc(i64 4)
  %1 = bitcast i8* %0 to %"class.hls::stream<int>"*
  call void @copy_out(%"class.hls::stream<int>"* %1, i32* %data_in, i32* null, i32* %data_out)
  call void @counter_hw_stub(%"class.hls::stream<int>"* %1, i32* %data_out, i32 %n_outer, i32 %n_inner)
  call void @copy_in(%"class.hls::stream<int>"* %1, i32* %data_in, i32* null, i32* %data_out)
  call void @free(i8* %0)
  ret void
}
