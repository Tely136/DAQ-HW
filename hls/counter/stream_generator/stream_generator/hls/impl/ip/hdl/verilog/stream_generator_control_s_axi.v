...
// ==============================================================
`timescale 1ns/1ps
(* DowngradeIPIdentifiedWarnings="yes" *) module stream_generator_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER            = 6'h08,
    ADDR_ISR            = 6'h0c,
    ADDR_N_TOTAL_DATA_0 = 6'h10,
    ADDR_N_TOTAL_CTRL   = 6'h14,
    ADDR_DATA_DATA_0    = 6'h18,
    ADDR_DATA_DATA_1    = 6'h1c,
    ADDR_DATA_CTRL      = 6'h20,
    WRIDLE              = 2'd0,
    WRDATA              = 2'd1,
    WRRESP              = 2'd2,
    WRRESET             = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_N_TOTAL_DATA_0: begin
                    rdata <= int_n_total[31:0];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_N_TOTAL_DATA_0)
            int_n_total[31:0] <= (WDATA[31:0] & wmask) | (int_n_total[31:0] & ~wmask);
    end
end
